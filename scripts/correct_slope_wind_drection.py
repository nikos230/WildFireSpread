...
if __name__ == "__main__":
    ...
    dataset_path = '/home/n.anastasiou/nvme1/n.anastasiou/dataset_64_64_all_10days_corrected'
    dataset_new_path = '/home/n.anastasiou/nvme1/n.anastasiou/dataset_64_64_all_10days_final'
    ...
    for year in tqdm(os.listdir(dataset_path)):
        ...
        for country in os.listdir(path_year):
            ...
            for sample in os.listdir(path_country):
                ...
                wind_speed = ds_sample['wind_speed']
